...
#
# Based on https://github.com/beneater/eeprom-programmer/blob/master/microcode-eeprom-with-flags/microcode-eeprom-with-flags.ino
...
with open("roms/microcode-with-flags.rom", "wb") as f:
    for address in range(1024):
        ...
        value = ucode[flags][instruction][step]
        if byte_sel:
